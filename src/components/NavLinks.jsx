...
const NavLinks = () => {
  return (
    ...
    <li>
      <Link
        to="/"
        className="block py-2 pl-3 pr-4 tracking-[.1rem] text-gray-600 font-md text-lg animate transition-all duration-500 rounded md:bg-transparent md:p-0 md:hover:text-teal-700 dark:md:hover:text-teal-600 dark:text-white"
        aria-current="page"
      >
        Home
      </Link>
